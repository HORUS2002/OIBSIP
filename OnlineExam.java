...
{  
    ...
    {  
        ...
        if(current==2)  
        {  
            l.setText("3) What is the size of float and double in java?");  
        ...
        if(current==3)  
        {  
            l.setText("4) Automatic type conversion is possible in which of the possible cases?");
            jb[0].setText("byte to int");
            jb[1].setText("int to long");
            jb[2].setText("long to int");
            jb[3].setText("short to int");  
        }  
        if(current==4)  
        {  
        ...
        if(current==7)  
        {  
            l.setText("8) Select the valid statement.");  
        ...
        if(current==8)  
        {  
            l.setText("9) The class at the top of exception class is ______?");  
        ...
        if(current==9)  
        {  
            l.setText("10) When an array is passed to a method, what does the method receive?");  
            jb[0].setText("The reference of the array");
            jb[1].setText("A copy of the array");
            jb[2].setText("Length of the array");  
            jb[3].setText("Copy of first element");  
        }  
        l.setBounds(30,40,450,20);  
